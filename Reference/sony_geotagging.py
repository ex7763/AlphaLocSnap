...
def set_loca[<35;25;15Mtion(latitude,longitude):
...
def sendToCamera(latitude, longitude):
    ...
    offset_dst_minBytes = of[<35;26;15Mfset_dst_min.to_bytes(2, byteorder='big')
...
def sony_init():
    ...
    # 2048 bytes for the this example. By [<35;26;14Mdefault, it is 200.
